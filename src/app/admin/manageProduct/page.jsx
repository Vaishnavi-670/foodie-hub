          ...
          const displayProductData = () =>{
            return productList.map(product => (
              <tr key={product._id}>
                ...
                <td>{product.price}</td>
                <td>{product.image}</td>
                <td><button onClick={() => deleteUser(product._id)}>Delete</button></td>
              </tr>
            ))
          }
  return (
                ...
                <tr className="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                  ...
                  <td className="h-px w-72 min-w-72 align-top">
                    <a className="block p-6" href="#">
                      ...
                      <span className="block text-sm text-gray-500 dark:text-neutral-500">
                        Material is great and very comfortable and stylish.
                      </span>
                    </a>
                  </td>
                  <td className="size-px whitespace-nowrap align-top">
                  ...
                  <td className="h-px w-72 min-w-72 align-top">
                    <a className="block p-6" href="#">
                      <div className="flex gap-x-1 mb-2">
                        ...
                        <svg
                          className="shrink-0 size-3 text-gray-400 dark:text-neutral-600"
                          xmlns="http://www.w3.org/2000/svg"
                          width={16}
                          height={16}
                          fill="currentColor"
                      ...
                      <span className="block text-sm text-gray-500 dark:text-neutral-500">
                        A really well built shoe. It looks great and wears just
                        as well. A great staple in ball caps.
                      </span>
                    </a>
                  </td>
                  <td className="size-px whitespace-nowrap align-top">
                ...
                <tr className="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                  ...
                  <td className="h-px w-72 min-w-72 align-top">
                    <a className="block p-6" href="#">
                      ...
                      <span className="block text-sm text-gray-500 dark:text-neutral-500">
                        As good as the heat Rdy T-shirt but without the sleeves.
