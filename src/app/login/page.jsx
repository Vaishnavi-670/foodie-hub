        ...
        <>
            <div className="min-h-screen flex justify-center items-center ">
                <div className=" bg-white shadow-2xl rounded-lg box-border text-center  flex flex-col justify-center items-center" style={{ height: '400px', margin: '10px 0 0 0', width: '350px', padding: '20px 30px', }}>
                    <p className=" font-sans text-2xl font-extrabold" style={{ margin: '10px 0 30px 0' }}>Login Page</p>
                    <form className="w-full flex flex-col gap-4 mb-3.5">
                        <input type="email" className="text-base rounded-full border border-gray-300 outline-none box-border p-3.5" placeholder="Enter your email" />
                        <input type="password" className="text-base rounded-full border border-gray-300 outline-none box-border p-3.5" placeholder="Password" />
                        <p className="underline m-0 text-right text-gray-500">
